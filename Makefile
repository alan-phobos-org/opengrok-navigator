...
.PHONY: all clean build-vscode build-chrome build-og dist-og dist-scripts test-og source dist dev help
...
dist: clean build-vscode build-chrome dist-og dist-scripts
...
dev: build-vscode build-chrome build-og
